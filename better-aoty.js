...
document.querySelectorAll(".rightContent").forEach((el) => {
  if (!el.textContent.includes("Featured Genres") && !el.textContent.includes("About") && !el.textContent.includes("Track List") && !el.textContent.includes("Stats") && !el.textContent.includes("Rating Distribution")) el.remove();
});
